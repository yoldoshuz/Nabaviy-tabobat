 ...
 * `messages/<locale>.json` — several of them from one list shared by the whole
 * range — which meant the only people who could change what a bottle claims
 * were the people with a git checkout. The admin now owns those sections, and this module is the seam:
