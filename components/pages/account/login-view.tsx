...
const FIELD =
  "h-12 w-full rounded-lg border border-border bg-white px-4 text-sm text-brand outline-none transition-shadow placeholder:text-brand/40 focus-visible:ring-3 focus-visible:ring-gold/60";
  ...
  return (
    <section className="bg-stone py-12 sm:py-16">
      <Container>
        ...
        <div className="rounded-lg bg-white p-6 shadow-float sm:p-8">
          <h1 className="text-2xl text-brand sm:text-3xl">
          ...
          {!sent && (
            <div className="mt-6 grid grid-cols-2 gap-1 rounded-lg bg-stone p-1">
          ...
          {sent ? (
            <form onSubmit={confirmCode} noValidate className="mt-6 flex flex-col gap-4">
              <label className="flex flex-col gap-1.5">
                <span className="text-xs text-brand/60">{t("code")}</span>
                <input
                  value={otp}
                  onChange={(event) =>
              ...
              <button
                ...
                className="inline-flex h-13 items-center justify-center gap-2 rounded-lg bg-gold text-sm font-medium text-brand transition-colors hover:bg-sand disabled:opacity-60"
              >
            ...
            <form onSubmit={sendCode} noValidate className="mt-6 flex flex-col gap-4">
              {mode === "register" && (
                <>
                  <label className="flex flex-col gap-1.5">
                    <span className="text-xs text-brand/60">{t("firstName")}</span>
                    <input
                      value={firstName}
                  ...
                  <label className="flex flex-col gap-1.5">
                    <span className="text-xs text-brand/60">{t("lastName")}</span>
                    <input
                      value={lastName}
              ...
              <label className="flex flex-col gap-1.5">
                <span className="text-xs text-brand/60">{t("phone")}</span>
                <input
                  value={phone}
